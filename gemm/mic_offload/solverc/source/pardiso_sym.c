...
MKL_INT ja[18] = { 1, 3, 6, 7,
	...
	7,
	8 };
float a[18] = { 7.0f, 1.0f, 2.0f, 7.0f,
	-4.0f, 8.0f, 2.0f,
	1.0f, 5.0f,
	7.0f, 9.0f,
	5.0f, 1.0f, 5.0f,
...
/* -------------------------------------------------------------------- */
	...
	iparm[12] = 0; /* Maximum weighted matching algorithm is switched 
			  off (default for symmetric); try iparm[12] = 1 
			  in case of accuracy is not acceptable */
